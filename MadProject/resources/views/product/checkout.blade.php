<x-app-layout>
    <div class="font-[sans-serif] bg-gray-200 pt-24">
        <div class="w-full mx-auto max-lg:max-w-xl">
            <div class="grid gap-6 lg:grid-cols-3">
                ...
                <div class="flex flex-col bg-gray-100 lg:h-screen lg:sticky lg:top-0">
                    <div class="p-6 overflow-auto flex-1 max-h-[calc(100vh-200px)]">
                        <h2 class="text-xl font-bold text-gray-800">Order Products</h2>
                        <div class="w-full mt-4 space-y-4">
                            @foreach($cartItems as $cartItem)
                                <div class="flex items-center gap-4">
                                    <img src="{{ asset('storage/' .$cartItem->product->images[0]) }}" class="w-16 h-16 rounded-md" />
                                    <div>
                    ...
                    <div class="sticky bottom-0 w-full p-4 bg-gray-200">
